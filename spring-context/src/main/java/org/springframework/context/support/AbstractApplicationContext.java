...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
		implements ConfigurableApplicationContext, ConfigurableListableBeanFactory {
	...
	public void refresh() throws BeansException, IllegalStateException {
		...
		synchronized (this.startupShutdownMonitor) {
			...
			try {
				...
				// Check for listener beans and register them. 注册事件监听器，监听器需要实现 ApplicationListener 接口
				registerListeners();
	...
	protected void initMessageSource() {
		...
		if (beanFactory.containsLocalBean(MESSAGE_SOURCE_BEAN_NAME)) {
			...
			// Make MessageSource aware of parent MessageSource. 设置父属性
	...
	protected void registerListeners() {
		 ...
		 * 同时提醒大伙注意：此处并没有说到 ApplicationListenerDetector 这个东东，下文会分解
		 */
	...
	protected void finishBeanFactoryInitialization(ConfigurableListableBeanFactory beanFactory) {
		...
		// Initialize conversion service for this context. 首先，初始化名字为 conversionService 的 Bean
		...
		// Instantiate all remaining (non-lazy-init) singletons. 开始初始化
